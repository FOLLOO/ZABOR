...
function ProfileCircle ({ img, size, edit, click }) {
  return (
    <div className={styles.main} style={{ width: `${size}px`, minWidth: `${size}px`, height: `${size}px` }} >
      { img ?
      ...
      {edit ?
        <div className={styles.edit}
            ...
            <img src={photo} alt={''}
                 style={{ width: `${size}px`, height: `${size}px`, position: 'relative', bottom: `${size}px`, opacity: 0.5}}/>
        </div>
        : null}
    </div>
  )
